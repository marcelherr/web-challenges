...
//   const checkAnimal = animals.includes(animalName);
//   return checkAnimal;
// }
...
function hasAnimal(animals, animalName) {
  ...
  const checkAnimal = lowerCaseAnimals.includes(lowerCaseAnimalName);
  return checkAnimal;
}

// function hasAnimal(animals, animalName) {
//   animalName = animalName.toLowerCase();
//   return animals.some((animal) => animal.toLowerCase() === animalName);
// }
